  ...
  return (
    <Routes>
      <Route path="/" element={<Secretary />}>
        ...
        <Route path="perfilView/aluno/:id" element={<ViewProfile />} />
        <Route path="perfilView/professor/:id" element={<ViewProfile />} />
        <Route path="perfilView/secretaria/:id" element={<ViewProfile />} />
