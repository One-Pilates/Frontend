...
export default function RedefinirSenha() {
  ...
  const steps = [{ label: 'Email' }, { label: 'Código' }, { label: 'Nova Senha' }];
    ...
    <div className="min-h-screen w-full flex items-center justify-center p-8 bg-orange-50/30 relative">
      ...
      <div className="bg-white dark:bg-dark-secondary rounded-2xl shadow-lg p-10 w-full max-w-2xl mx-auto">
        ...
        {currentStep === 1 && (
          <div className="flex flex-col gap-8">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-gray-800 mb-3">Redefinir Senha</h1>
            ...
            <form className="flex flex-col gap-6" onSubmit={handleEnviarEmail}>
              <div className="flex flex-col gap-2">
                <label
                  htmlFor="email"
                  className="text-[15px] font-semibold text-gray-700 dark:text-fontMain"
                >
                  Email
                </label>
                <input
        ...
        {currentStep === 2 && (
          <div className="flex flex-col gap-8">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-gray-800 mb-3">Código de Verificação</h1>
              <p className="text-base text-gray-600 dark:text-fontSec leading-relaxed">
            ...
            <p className="text-center text-green-600 text-[15px] py-3.5 bg-green-50 rounded-xl border border-green-600 m-0">
              ✓ Código enviado para <strong className="font-semibold">{email}</strong>
            </p>
        ...
        {currentStep === 3 && (
          <div className="flex flex-col gap-8">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-gray-800 mb-3">Criar Nova Senha</h1>
              <p className="text-base text-gray-600 dark:text-fontSec leading-relaxed">
