      ...
      <div className="max-w-4xl mx-auto py-16 px-6 md:px-12">
        <header className="mb-20">
          ...
          <p className="text-slate-400 font-medium flex items-center gap-2">
            Versão 1.0 <span className="w-1 h-1 rounded-full bg-slate-200" /> Atualizado em 17 de
            Abril de 2026
          </p>
        </header>
        ...
        <div className="space-y-16">
          <section className="group">
            ...
            <div className="text-slate-600 leading-relaxed text-lg pl-12">
              <p>
                Bem-vindo à plataforma OnePilates. Ao utilizar nossos serviços, você aceita
                integralmente estes Termos de Uso. Este documento regula o acesso e a utilização do
                nosso sistema de gerenciamento de estúdios.
              </p>
            </div>
          </section>
          ...
          <section className="group">
            ...
            <div className="text-slate-600 leading-relaxed text-lg pl-12 space-y-6">
              <p>
                Como usuário do OnePilates (aluno ou instrutor), você se compromete a fornecer
                informações precisas e a manter a segurança de suas credenciais de acesso.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50 p-8 rounded-2xl border border-slate-100">
                <div className="flex gap-4">
                  ...
                  <p className="text-sm font-medium">
                    Uso correto das ferramentas de agendamento e cancelamento.
                  </p>
                </div>
                <div className="flex gap-4">
                  <FiChevronRight className="text-orange-500 shrink-0 mt-1" />
                  <p className="text-sm font-medium">
                    Proteção de dados sensíveis e senhas pessoais.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="group">
            ...
            <div className="text-slate-600 leading-relaxed text-lg pl-12">
              <p>
                O sistema OnePilates é um facilitador. As regras de cada estúdio parceiro (horários,
                faltas, reposições) são definidas individualmente e devem ser respeitadas conforme o
                contrato firmado com a unidade física.
              </p>
            </div>
          </section>
            ...
            <div className="flex flex-col md:flex-row justify-between gap-8">
              <div className="max-w-md">
                ...
                <p className="text-slate-500 text-sm">
                  Se você tiver qualquer dúvida sobre como operamos, nossa equipe de suporte está
                  pronta para ajudar.
                </p>
              </div>
              <a
